...
for img in img_item:
    ...
    img_url_rel = f'https://marshemispheres.com/{img_url}'
    
    img_url = img.find('img', class_='thumb').get('src')
    img_url_rel = f'https://marshemispheres.com/{img_url}'
    hemisphere_image_urls.append(img_url_rel)

    title = img.find('h3').text.strip()
